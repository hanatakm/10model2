		 ...
		 $(function(){
		   ...
		   $(".Depth03:contains('개인정보조회')").on("click", function(){
		     window.parent.frames["rightFrame"].location.href =
		       "${pageContext.request.contextPath}/user/getUser?userId=${user.userId}";
		   });

		   // 회원정보조회
		   $(".Depth03:contains('회원정보조회')").on("click", function(){
		     window.parent.frames["rightFrame"].location.href =
		       "${pageContext.request.contextPath}/user/listUser";
		   });

		   // 판매상품등록
		   $(".Depth03:contains('판매상품등록')").on("click", function(){
		     window.parent.frames["rightFrame"].location.href =
		       "${pageContext.request.contextPath}/product/addProductView.jsp";
		   });

		   // 판매상품관리
		   $(".Depth03:contains('판매상품관리')").on("click", function(){
		     window.parent.frames["rightFrame"].location.href =
		       "${pageContext.request.contextPath}/product/listProduct?menu=manage";
		   });

		   // 상품검색
		   $(".Depth03:contains('상 품 검 색')").on("click", function(){
		     window.parent.frames["rightFrame"].location.href =
		       "${pageContext.request.contextPath}/product/listProduct?menu=search";
		   });

		   // 구매이력조회
		   $(".Depth03:contains('구매이력조회')").on("click", function(){
		     window.parent.frames["rightFrame"].location.href =
		       "${pageContext.request.contextPath}/purchase/listPurchase";
				   });
		  ...
		  window.open("${pageContext.request.contextPath}/history.jsp",
		    "popWin","left=300,top=200,width=300,height=200,scrollbars=no,resizable=no");
		});
